...
const REVIEWS = [
  {
    ...
    rating: 5,
    text: 'Booked a heritage stay in Jaipur through Swaraah — the vendor was incredibly responsive and the price was exactly what was shown. No hidden charges. The real-time driver tracking was also super reassuring when we were landing at midnight.',
  ...
  },
  {
    ...
    rating: 5,
    text: 'Used Swaraah to plan a full 10-day Kerala trip — stays, backwater boat activity, and all restaurant reservations. Everything connected seamlessly. The Voyage Coins I earned on the first booking paid for my last meal. Brilliant concept.',
